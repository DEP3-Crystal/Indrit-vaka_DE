...
public class SchemaDefinitionInMemory {
    public static void main(String[] args) {
        ...
        Row row1 = Row.withSchema(schema).addValues(
                "1/5/09 5:39", "Shoes", 120f, "Amex", "Netherlands").build();
        Row row2 = Row.withSchema(schema).addValues(
                "2/2/09 9:16", "Jeans", 110f, "Mastercard", "United States").build();
        Row row3 = Row.withSchema(schema).addValues(
                "3/5/09 10:08", "Pens", 10f, "Visa", "United States").build();
        Row row4 = Row.withSchema(schema).addValues(
                "4/2/09 14:18", "Shoes", 303f, "Visa", "United States").build();
        Row row5 = Row.withSchema(schema).addValues(
                "5/4/09 1:05", "iPhone", 1240f, "Diners", "Ireland").build();
        Row row6 = Row.withSchema(schema).addValues(
                "6/5/09 11:37", "TV", 1503f, "Visa", "Canada").build();
