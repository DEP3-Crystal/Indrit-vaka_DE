...
import swagger.*;
import swagger.model.CountryInfoDto;
import swagger.model.CountryV3Dto;
...
public class CountryApi {
    ...
    public ApiResponse<List<CountryV3Dto>> countryAvailableCountriesWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<CountryV3Dto>>() {
        }.getType();
    ...
    public ApiResponse<CountryInfoDto> countryCountryInfoWithHttpInfo(String countryCode) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<CountryInfoDto>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
